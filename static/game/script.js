...
function toggle_win_screen(){
    document.getElementById('win_screen_players').innerText = `${urlParams.get('name')} vs ${data.opponent}`;
    document.getElementById('win_screen_game_status').innerText = data.status;
    document.getElementById('win_screen_gesture_image').innerText = data.gesture_image;
